...
public class MascotaJpaController implements Serializable {
    ...
    //creo la EntityManagerFactory y paso el nombre de la persistencia que lo pide el constructor
    public MascotaJpaController(){
        
        emf = Persistence.createEntityManagerFactory("Pierro_Rafael_Tpo2PU");
    }
